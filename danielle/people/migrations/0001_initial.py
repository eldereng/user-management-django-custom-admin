    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('pacient', 'Paciente'), ('companion', 'Acompanhante'), ('professional', 'Profissional'), ('voluntary', 'Voluntário'), ('visitor', 'Visitantes'), ('other', 'Outros')], max_length=12, verbose_name='Tipo de check-in')),
                ('treatment', models.CharField(blank=True, choices=[('chemotherapy', 'Quimioterapia'), ('radiotherapy', 'Radioterapia'), ('surgery', 'Cirurgia'), ('exams', 'Exames'), ('appointment', 'Consulta'), ('other', 'Outro')], max_length=12, null=True, verbose_name='Motivo')),
