    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('P', 'Paciente'), ('A', 'Acompanhante'), ('F', 'Profissional'), ('V', 'Voluntário'), ('S', 'Visitantes'), ('O', 'Outros')], max_length=1, verbose_name='Tipo de check-in')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(blank=True, help_text='Exemplo: 000.000.000-00', max_length=14, null=True, verbose_name='CPF')),
