    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(blank=True, help_text='Exemplo: 000.000.000-00', max_length=14, null=True, unique=True, validators=[utils.cpf.check_cpf.check_cpf], verbose_name='CPF')),
                ...
                ('private_phone', models.CharField(blank=True, help_text='Exemplo: 99999-9999', max_length=10, null=True, validators=[utils.phone.check_phone.check_phone], verbose_name='Tel. p/ contato')),
                ...
                ('message_phone', models.CharField(blank=True, help_text='Exemplo: 99999-9999', max_length=10, null=True, verbose_name='Tel. p/ mensagem')),
                ('observation', models.TextField(blank=True, max_length=600, null=True, verbose_name='Observação')),
            ],
            options={
                'verbose_name': 'Pessoa',
